...
BronzePawnQuestionTexture = "|TInterface\\AddOns\\BronzePawn\\Textures\\Question:0|t" -- Texture string that represents a (?).  Don't need to localize this.
BronzePawnUINoScale = "(none)" -- The name that shows up in lists of scales if you have no scales

------------------------------------------------------------
-- Master table of stats
------------------------------------------------------------

-- The master list of all stats that BronzePawn supports.
-- First column is the friendly translated name of the stat.
-- Second column is the BronzePawn name of the stat; this can't be translated.
...
-- lines or set them to nil, and BronzePawn won't show tooltips for those UI elements.


-- Configuration UI
BronzePawnUIFrame_CloseButton_Text = "Close"
BronzePawnUIHeaders = -- (%s is the name of the current scale)
{
	"Manage your BronzePawn scales", -- Scale tab
	"Scale values for %s", -- Values tab
	"Compare items using %s", -- Compare tab
	"Gems for %s", -- Gems tab
	"Adjust BronzePawn options", -- Options tab
	"About BronzePawn", -- About tab
	"Welcome to BronzePawn!", -- Getting Started tab
}

-- Configuration UI, Scale selector
BronzePawnUIFrame_ScaleSelector_Header_Text = "Select a scale:"

-- Configuration UI, Scale tab (this is a new tab; the old Scales tab is now the Values tab)
BronzePawnUIFrame_ScalesTab_Text = "Scale"

BronzePawnUIFrame_ScalesWelcomeLabel_Text = "Scales are sets of stats and values that are used to assign point values to items.  You can customize your own or use scale values that others have created."

BronzePawnUIFrame_ShowScaleCheck_Label_Text = "Show scale in tooltips"
BronzePawnUIFrame_ShowScaleCheck_Tooltip = "When this option is checked, values for this scale will show up in item tooltips for this character.  Each scale can show up for one of your characters, multiple characters, or no characters at all."
BronzePawnUIFrame_RenameScaleButton_Text = "Rename"
BronzePawnUIFrame_RenameScaleButton_Tooltip = "Rename this scale."
BronzePawnUIFrame_DeleteScaleButton_Text = "Delete"
BronzePawnUIFrame_DeleteScaleButton_Tooltip = "Delete this scale.\n\nThis command cannot be undone!"
BronzePawnUIFrame_ScaleColorSwatch_Label_Text = "Change color"
BronzePawnUIFrame_ScaleColorSwatch_Tooltip = "Change the color that this scale's name and value appear in on item tooltips."
BronzePawnUIFrame_ScaleTypeLabel_NormalScaleText = "You can change this scale on the Values tab."
BronzePawnUIFrame_ScaleTypeLabel_ReadOnlyScaleText = "You must make a copy of this scale if you want to customize it."

BronzePawnUIFrame_ScaleSettingsShareHeader_Text = "Share your scales"

BronzePawnUIFrame_ImportScaleButton_Text = "Import"
BronzePawnUIFrame_ImportScaleButton_Label_Text = "Add a new scale by pasting a scale tag from the internet."
BronzePawnUIFrame_ExportScaleButton_Text = "Export"
BronzePawnUIFrame_ExportScaleButton_Label_Text = "Share your scale with others on the internet."

BronzePawnUIFrame_ScaleSettingsNewHeader_Text = "Create a new scale"

BronzePawnUIFrame_CopyScaleButton_Text = "Copy"
BronzePawnUIFrame_CopyScaleButton_Label_Text = "Create a new scale by making a copy of this one."
BronzePawnUIFrame_NewScaleButton_Text = "Empty"
BronzePawnUIFrame_NewScaleButton_Label_Text = "Create a new scale from scratch."
BronzePawnUIFrame_NewScaleFromDefaultsButton_Text = "Defaults"
BronzePawnUIFrame_NewScaleFromDefaultsButton_Label_Text = "Create a new scale by making a copy of the defaults."

-- Configuration UI, Values tab (previously the Scales tab)
BronzePawnUIFrame_ValuesTab_Text = "Values"

BronzePawnUIFrame_ValuesWelcomeLabel_NormalText = "You can customize the values that are assigned to each stat for this scale.  To manage your scales and add new ones, use the Scale tab."
BronzePawnUIFrame_ValuesWelcomeLabel_NoScalesText = "You have no scale selected.  To get started, go to the Scale tab and start a new scale or paste one from the internet."
BronzePawnUIFrame_ValuesWelcomeLabel_ReadOnlyScaleText = "The scale that you have selected can't be changed.  If you'd like to change these values, go to the Scale tab and make a copy of this scale or start a new one."

BronzePawnUIFrame_ClearValueButton_Text = "Remove"
BronzePawnUIFrame_ClearValueButton_Tooltip = "Remove this stat from the scale."

BronzePawnUIFrame_ScaleSocketOptionsHeaderLabel_Text = "When calculating a value for this scale:"
BronzePawnUIFrame_ScaleSocketBestRadio_Text = "Automatically handle sockets for me"
BronzePawnUIFrame_ScaleSocketBestRadio_Tooltip = "BronzePawn will calculate a value for this scale assuming that you would socket the item with the gems that would maximize the value of the item."
BronzePawnUIFrame_ScaleSocketCorrectRadio_Text = "Let me manually pick a socket value"
BronzePawnUIFrame_ScaleSocketCorrectRadio_Tooltip = "BronzePawn will calculate a value for this scale based on the number you specify."

BronzePawnUIFrame_NormalizeValuesCheck_Text = "Normalize values (like Wowhead)"
BronzePawnUIFrame_NormalizeValuesCheck_Tooltip = "Enable this option to divide the final calculated value for an item by the sum of all stat values in your scale, like Wowhead and Lootzor do.  This helps to even out situations like where one scale has stat values around 1 and another has values around 5.  It also helps to keep numbers manageably small.\n\nFor more information on this setting, see the readme file."

-- Configuration UI, Compare tab
BronzePawnUIFrame_CompareTab_Text = "Compare"

BronzePawnUIFrame_VersusHeader_Text = "—vs.—" -- Short for "versus."  Appears between the names of the two items.
BronzePawnUIFrame_VersusHeader_NoItem = "(no item)" -- Text displayed next to empty item slots.

BronzePawnUIFrame_CompareMissingItemInfo_TextLeft = "First, pick a scale from the list on the left."
BronzePawnUIFrame_CompareMissingItemInfo_TextRight = "Then, drop an item in this box.\n\nBronzePawn will compare it versus your equipped item."

BronzePawnUIFrame_CompareSocketBonusHeader_Text = "Socket bonus" -- Heading that appears above the item socket bonuses.

BronzePawnUIFrame_CompareOtherInfoHeader_Text = "Other" -- Heading that appears above the item's level and the following stats:
BronzePawnUIFrame_CompareAsterisk = "Special effects " .. BronzePawnQuestionTexture
BronzePawnUIFrame_CompareAsterisk_Yes = "Yes" -- Appears on the Compare tab when an item has special effects (?).

BronzePawnUIFrame_CurrentCompareScaleDropDown_Label_Text = "Comparison scale"
BronzePawnUIFrame_CurrentCompareScaleDropDown_Tooltip = "Select a new scale to use when comparing the two items."

BronzePawnUIFrame_ClearItemsButton_Label = "Clear"
BronzePawnUIFrame_ClearItemsButton_Tooltip = "Remove both comparison items."

BronzePawnUIFrame_CompareSwapButton_Text = "< Swap >"
BronzePawnUIFrame_CompareSwapButton_Tooltip = "Swap the item on the left side with the one on the right."

-- Configuration UI, Gems tab
BronzePawnUIFrame_GemsTab_Text = "Gems"
BronzePawnUIFrame_GemsHeaderLabel_Text = "Choose a scale to have BronzePawn determine the best gems available according to the values in that scale."

BronzePawnUIFrame_CurrentGemsScaleDropDown_Label_Text = "Find the best gems for:"
BronzePawnUIFrame_CurrentGemsScaleDropDown_Tooltip = "Select a scale for which to calculate gem values."

BronzePawnUIFrame_GemQualityDropDown_Label_Text = "Quality:"
BronzePawnUIFrame_GemQualityDropDown_Tooltip = "Select the quality of gems for BronzePawn to consider."

BronzePawnUIFrame_FindGemColorHeader_Text = "%s gems" -- Red
BronzePawnUIFrame_FindGemColorHeader_Meta_Text = "Meta gems (ignoring effects)"
BronzePawnUIFrame_FindGemNoGemsHeader_Text = "No gems found."

-- Configuration UI, Options tab
BronzePawnUIFrame_OptionsTab_Text = "Options"
BronzePawnUIFrame_OptionsHeaderLabel_Text = "Configure BronzePawn the way you like it.  Changes will take effect immediately."

BronzePawnUIFrame_TooltipOptionsHeaderLabel_Text = "Tooltip options"
BronzePawnUIFrame_ShowItemLevelsCheck_Text = "Show item levels"
BronzePawnUIFrame_ShowItemLevelsCheck_Tooltip = "Enable this option to have BronzePawn display the item level of every item you come across.\n\nEvery item in World of Warcraft has a hidden level that is used to determine how many stats it can have.  In general, an item of the same type (helmet, cloak) and quality (green, blue) and a higher level will have more, or at least better, stats."
BronzePawnUIFrame_ShowItemIDsCheck_Text = "Show item IDs"
BronzePawnUIFrame_ShowItemIDsCheck_Tooltip = "Enable this option to have BronzePawn display the item ID of every item you come across, as well as the IDs of all enchantments and gems.\n\nEvery item in World of Warcraft has an ID number associated with it.  This information is generally only useful to mod authors."
BronzePawnUIFrame_ShowIconsCheck_Text = "Show inventory icons"
BronzePawnUIFrame_ShowIconsCheck_Tooltip = "Enable this option to show inventory icons next to item link windows."
BronzePawnUIFrame_ShowExtraSpaceCheck_Text = "Add a blank line before values"
BronzePawnUIFrame_ShowExtraSpaceCheck_Tooltip = "Keep your item tooltips extra tidy by enabling this option, which adds a blank line before the BronzePawn values."
BronzePawnUIFrame_AlignRightCheck_Text = "Align values to right edge of tooltip"
BronzePawnUIFrame_AlignRightCheck_Tooltip = "Enable this option to align your BronzePawn values (as well as item levels and item IDs) to the right edge of the tooltip instead of the left."
BronzePawnUIFrame_AsterisksHeaderLabel_Text = "Show " .. BronzePawnQuestionTexture .. " on special effects:"
BronzePawnUIFrame_AsterisksAutoRadio_Text = "On"
BronzePawnUIFrame_AsterisksAutoRadio_Tooltip = "Show the " .. BronzePawnQuestionTexture .. " icon on items that have special effects (like trinkets)."
BronzePawnUIFrame_AsterisksAutoNoTextRadio_Text = "On, but don't add the warning"
BronzePawnUIFrame_AsterisksAutoNoTextRadio_Tooltip = "Same as On, but don't show the 'Special effects not included' warning message."
BronzePawnUIFrame_AsterisksOffRadio_Text = "Off"
BronzePawnUIFrame_AsterisksOffRadio_Tooltip = "Don't show the " .. BronzePawnQuestionTexture .. " icon or the warning message."

BronzePawnUIFrame_CalculationOptionsHeaderLabel_Text = "Calculation options"
BronzePawnUIFrame_DigitsBox_Label_Text = "Digits of precision:"
BronzePawnUIFrame_DigitsBox_Tooltip = "Specify how many digits of precision you want in your BronzePawn values, 0-9.  0 rounds all BronzePawn values to whole numbers ('25').  1 is the default ('24.5')."
BronzePawnUIFrame_UnenchantedValuesCheck_Text = "Show base values for items"
BronzePawnUIFrame_UnenchantedValuesCheck_Tooltip = "Enable this option to have BronzePawn show values for unmodified versions of items, as if they were just dropped or was bought from the vendor.\n\nIf the current value and base value are both visible and not equal, the base value will be shown second, in parentheses."
BronzePawnUIFrame_EnchantedValuesCheck_Text = "Show current values for items"
BronzePawnUIFrame_EnchantedValuesCheck_Tooltip = "Enable this option to have BronzePawn show values for items exactly as they are, including all enchantments and gems if present.  Empty sockets are ignored.\n\nIf the current value and base value are both visible and not equal, the current value will be shown first."
BronzePawnUIFrame_DebugCheck_Text = "Show debug info"
BronzePawnUIFrame_DebugCheck_Tooltip = "If you're not sure how BronzePawn is calculating the values for a particular item, enable this option to make BronzePawn spam all sorts of 'useful' data to the chat console whenever you hover over an item.  This information includes which stats BronzePawn thinks the item has, which parts of the item BronzePawn doesn't understand, and how it took each one into account for each of your scales.\n\nThis option will fill up your chat log quickly, so you'll want to turn it off once you're finished investigating.\n\nShortcuts:\n/bronzepawn debug on\n/bronzepawn debug off"

BronzePawnUIFrame_OtherOptionsHeaderLabel_Text = "Other options"
BronzePawnUIFrame_ButtonPositionHeaderLabel_Text = "Show the BronzePawn button:"
BronzePawnUIFrame_ButtonRightRadio_Text = "On the right"
BronzePawnUIFrame_ButtonRightRadio_Tooltip = "Show the BronzePawn button in the lower-right corner of the Character Info panel."
BronzePawnUIFrame_ButtonLeftRadio_Text = "On the left"
BronzePawnUIFrame_ButtonLeftRadio_Tooltip = "Show the BronzePawn button in the lower-left corner of the Character Info panel."
BronzePawnUIFrame_ButtonOffRadio_Text = "Hide it"
BronzePawnUIFrame_ButtonOffRadio_Tooltip = "Don't show the BronzePawn button on the Character Info panel."

-- Configuration UI, About tab
BronzePawnUIFrame_AboutTab_Text = "About"
BronzePawnUIFrame_AboutHeaderLabel_Text = "created by MeuchelManni"
BronzePawnUIFrame_AboutVersionLabel_Text = "Version %s"
BronzePawnUIFrame_AboutTranslationLabel_Text = "Official English version" -- Translators: credit yourself here... "Klingon translation by Stovokor"
BronzePawnUIFrame_ReadmeLabel_Text = "New to BronzePawn?  See the getting started tab for a really basic introduction.  You can learn about more advanced features in the readme file that comes with BronzePawn."
BronzePawnUIFrame_WebsiteLabel_Text = "BronzePawn includes optional Wowhead stat weight presets.  If you have feedback on those scale values, please direct it to the appropriate Wowhead Theorycrafting forum threads."

-- Configuration UI, Help tab
BronzePawnUIFrame_HelpTab_Text = "Getting started"
BronzePawnUIFrame_GettingStartedLabel_Text =
	"BronzePawn calculates scores for items that let you easily see which one is better for you.  These scores show up at the bottom of all your item tooltips.\n\n\n" ..
	...
	"BronzePawn includes optional scales from Wowhead for each class and spec.  You can turn scales on and off, create your own by assigning point values to each stat, and even share scales on the internet.\n\n\n" ..
	VgerCore.Color.Blue .. "Try out these features once you learn the basics:\n" .. VgerCore.Color.Reset ..
	" • Compare the stats of two items by using BronzePawn's Compare tab.\n" ..
	" • Right-click on an item link window to see how it compares to your current item.\n" ..
	" • Shift-right-click an item with sockets to have BronzePawn suggest gems for it.\n" ..
	...
	" • Check out the readme file to learn more about BronzePawn's advanced features."
	
-- Inventory button
BronzePawnUI_InventoryBronzePawnButton_Tooltip = "Click to show the BronzePawn UI."
BronzePawnUI_InventoryBronzePawnButton_Subheader = "Totals for all equipped items:"

-- Socketing button
BronzePawnUI_SocketingBronzePawnButton_Tooltip = "Click to show the BronzePawn Gems UI."

-- Item socketing UI
BronzePawnUI_ItemSocketingDescription_Header = "BronzePawn suggests the following gems:"

-- Interface Options page
BronzePawnInterfaceOptionsFrame_OptionsHeaderLabel_Text = "BronzePawn options are found in the BronzePawn UI."
BronzePawnInterfaceOptionsFrame_OptionsSubHeaderLabel_Text = "Click the BronzePawn button to go there.  You can also open BronzePawn from your inventory page, or by binding a key to it."

-- Bindings UI
BINDING_HEADER_BRONZEPAWN = "BronzePawn"
BINDING_NAME_BRONZEPAWN_TOGGLE_UI = "Toggle BronzePawn UI" -- Show or hide the BronzePawn UI
PAWN_TOGGLE_UI_DEFAULT_KEY = "P" -- Default key to assign to this command
BINDING_NAME_BRONZEPAWN_COMPARE_LEFT = "Compare item (left)" -- Set the currently hovered item to be the left-side Compare item
PAWN_COMPARE_LEFT_DEFAULT_KEY = "[" -- Default key to assign to this command
BINDING_NAME_BRONZEPAWN_COMPARE_RIGHT = "Compare item (right)" -- Set the currently hovered item to be the right-side Compare item
...
BronzePawnLocal =
{
	...
	-- General messages
	["NeedNewerVgerCoreMessage"] = "BronzePawn needs a newer version of VgerCore.  Please use the version of VgerCore that came with BronzePawn.",
	...
	["ImportScaleTagErrorMessage"] = "BronzePawn doesn't understand that scale tag.  Did you copy the whole tag?  Try copying and pasting again:",
	...
	["AsteriskTooltipLine"] = "|TInterface\\AddOns\\BronzePawn\\Textures\\Question:0|t Special effects not included in the value.",
...
/bronzepawn -- show or hide the BronzePawn UI
/bronzepawn debug [ on | off ] -- spam debug messages to the console
/bronzepawn backup -- backup all of your scales to scale tags
 
For more information on customizing BronzePawn, please see the help file (Readme.htm) that comes with the mod.
]],
...
BronzePawnWowheadScale_Provider = "Wowhead scales"
BronzePawnWowheadScale_WarriorArms = "Warrior: arms"
BronzePawnWowheadScale_WarriorFury = "Warrior: fury"
BronzePawnWowheadScale_WarriorTank = "Warrior: tank"
BronzePawnWowheadScale_PaladinHoly = "Paladin: holy"
BronzePawnWowheadScale_PaladinTank = "Paladin: tank"
BronzePawnWowheadScale_PaladinRetribution = "Paladin: retribution"
BronzePawnWowheadScale_HunterBeastMastery = "Hunter: beast mastery"
BronzePawnWowheadScale_HunterMarksman = "Hunter: marksman"
BronzePawnWowheadScale_HunterSurvival = "Hunter: survival"
BronzePawnWowheadScale_RogueAssassination = "Rogue: assassination"
BronzePawnWowheadScale_RogueCombat = "Rogue: combat"
BronzePawnWowheadScale_RogueSubtlety = "Rogue: subtlety"
BronzePawnWowheadScale_PriestDiscipline = "Priest: discipline"
BronzePawnWowheadScale_PriestHoly = "Priest: holy"
BronzePawnWowheadScale_PriestShadow = "Priest: shadow"
BronzePawnWowheadScale_DeathKnightBloodDps = "DK: blood DPS"
BronzePawnWowheadScale_DeathKnightBloodTank = "DK: blood tank"
BronzePawnWowheadScale_DeathKnightFrostDps = "DK: frost DPS"
BronzePawnWowheadScale_DeathKnightFrostTank = "DK: frost tank"
BronzePawnWowheadScale_DeathKnightUnholyDps = "DK: unholy DPS"
BronzePawnWowheadScale_ShamanElemental = "Shaman: elemental"
BronzePawnWowheadScale_ShamanEnhancement = "Shaman: enhancement"
BronzePawnWowheadScale_ShamanRestoration = "Shaman: restoration"
BronzePawnWowheadScale_MageArcane = "Mage: arcane"
BronzePawnWowheadScale_MageFire = "Mage: fire"
BronzePawnWowheadScale_MageFrost = "Mage: frost"
BronzePawnWowheadScale_WarlockAffliction = "Warlock: affliction"
BronzePawnWowheadScale_WarlockDemonology = "Warlock: demonology"
BronzePawnWowheadScale_WarlockDestruction = "Warlock: destruction"
BronzePawnWowheadScale_DruidBalance = "Druid: balance"
BronzePawnWowheadScale_DruidFeralDps = "Druid: feral cat"
BronzePawnWowheadScale_DruidFeralTank = "Druid: feral bear"
BronzePawnWowheadScale_DruidRestoration = "Druid: restoration"
...
function BronzePawnGameConstant(Text)
	return "^" .. BronzePawnGameConstantUnwrapped(Text) .. "$"
end
function BronzePawnGameConstantUnwrapped(Text)
...
BronzePawnSocketBonusPrefix = "Socket Bonus: "
...
BronzePawnSeparatorIgnorePrefixes =
{
	'"', -- double quote
	"Equip:",
	"Use:",
...
-- This is a list of regular expression substitutions that BronzePawn performs to normalize stat names before running
-- them through the normal gauntlet of expressions.
BronzePawnNormalizationRegexes =
{
...
-- Source is either BronzePawnMultipleStatsFixed if Number is the amount of the stat, or BronzePawnMultipleStatsExtract or nil if Number is the matches array index.
...
BronzePawnMultipleStatsFixed = "_MultipleFixed"
BronzePawnMultipleStatsExtract = "_MultipleExtract"
BronzePawnRegexes =
{
	-- ========================================
	...
	-- ========================================
	{BronzePawnGameConstant(ITEM_QUALITY0_DESC)}, -- Poor
	{BronzePawnGameConstant(ITEM_QUALITY1_DESC)}, -- Common
	{BronzePawnGameConstant(ITEM_QUALITY2_DESC)}, -- Uncommon
	{BronzePawnGameConstant(ITEM_QUALITY3_DESC)}, -- Rare
	{BronzePawnGameConstant(ITEM_QUALITY4_DESC)}, -- Epic
	{BronzePawnGameConstant(ITEM_QUALITY5_DESC)}, -- Legendary
	{BronzePawnGameConstant(ITEM_QUALITY7_DESC)}, -- Heirloom
	{BronzePawnGameConstant(ITEM_HEROIC)}, -- Heroic (Thrall's Chestguard of Triumph, level 258 version)
	{BronzePawnGameConstant(ITEM_HEROIC_EPIC)}, -- Heroic Epic (Thrall's Chestguard of Triumph, level 258 version, with colorblind mode on)
	{"^" .. ITEM_LEVEL}, -- Item Level 200
	{BronzePawnGameConstant(ITEM_UNSELLABLE)}, -- No sell price
	{BronzePawnGameConstant(ITEM_SOULBOUND)}, -- Soulbound
	{BronzePawnGameConstant(ITEM_BIND_ON_EQUIP)}, -- Binds when equipped
	{BronzePawnGameConstant(ITEM_BIND_ON_PICKUP)}, -- Binds when picked up
	{BronzePawnGameConstant(ITEM_BIND_ON_USE)}, -- Binds when used
	{BronzePawnGameConstant(ITEM_BIND_TO_ACCOUNT)}, -- Binds to account (Polished Spaulders of Valor)
	{"^" .. BronzePawnGameConstantUnwrapped(ITEM_UNIQUE)}, -- Unique; leave off the $ for Unique(20)
	{"^" .. BronzePawnGameConstantUnwrapped(ITEM_BIND_QUEST)}, -- Leave off the $ for MonkeyQuest mod compatibility
	{BronzePawnGameConstant(ITEM_STARTS_QUEST)}, -- This Item Begins a Quest
	{BronzePawnGameConstant(ITEM_CONJURED)}, -- Conjured Item
	{BronzePawnGameConstant(ITEM_PROSPECTABLE)}, -- Prospectable
	{BronzePawnGameConstant(ITEM_MILLABLE)}, -- Millable
	{BronzePawnGameConstant(ITEM_DISENCHANT_NOT_DISENCHANTABLE)}, -- Cannot be disenchanted
	...
	{BronzePawnGameConstant(ITEM_ENCHANT_DISCLAIMER)}, -- Item will not be traded!
	{"^.+ Charges?$"}, -- Brilliant Mana Oil
	{BronzePawnGameConstant(LOCKED)}, -- Locked
	{BronzePawnGameConstant(ENCRYPTED)}, -- Encrypted (Floral Foundations) (does not seem to exist in the game yet)
	{BronzePawnGameConstant(ITEM_SPELL_KNOWN)}, -- Already Known
	{BronzePawnGameConstant(INVTYPE_HEAD)}, -- Head
	{BronzePawnGameConstant(INVTYPE_NECK)}, -- Neck
	{BronzePawnGameConstant(INVTYPE_SHOULDER)}, -- Shoulder
	{BronzePawnGameConstant(INVTYPE_CLOAK), "IsCloth", 1, BronzePawnMultipleStatsFixed}, -- Back (cloaks are cloth even though they don't list it)
	{BronzePawnGameConstant(INVTYPE_ROBE)}, -- Chest
	{BronzePawnGameConstant(INVTYPE_BODY)}, -- Shirt
	{BronzePawnGameConstant(INVTYPE_TABARD)}, -- Tabard
	{BronzePawnGameConstant(INVTYPE_WRIST)}, -- Wrist
	{BronzePawnGameConstant(INVTYPE_HAND)}, -- Hands
	{BronzePawnGameConstant(INVTYPE_WAIST)}, -- Waist
	{BronzePawnGameConstant(INVTYPE_FEET)}, -- Feet
	{BronzePawnGameConstant(INVTYPE_LEGS)}, -- Legs
	{BronzePawnGameConstant(INVTYPE_FINGER)}, -- Finger
	{BronzePawnGameConstant(INVTYPE_TRINKET)}, -- Trinket
	{BronzePawnGameConstant(MAJOR_GLYPH)}, -- Major Glyph
	{BronzePawnGameConstant(MINOR_GLYPH)}, -- Minor Glyph
	{"^Totem$"},
	{"^Relic$"},
	{"^Idol$"},
	{"^Libram$"},
	...
	-- ========================================
	-- Strings that represent statistics that BronzePawn cares about
	-- ========================================
	{BronzePawnGameConstant(INVTYPE_RANGED), "IsRanged", 1, BronzePawnMultipleStatsFixed}, -- Ranged
	{"^Projectile$", "IsRanged", 1, BronzePawnMultipleStatsFixed}, -- Projectile
	{BronzePawnGameConstant(INVTYPE_THROWN), "IsRanged", 1, BronzePawnMultipleStatsFixed}, -- Thrown
	{BronzePawnGameConstant(INVTYPE_WEAPON), "IsOneHand", 1, BronzePawnMultipleStatsFixed}, -- One-Hand
	{BronzePawnGameConstant(INVTYPE_2HWEAPON), "IsTwoHand", 1, BronzePawnMultipleStatsFixed}, -- Two-Hand
	{BronzePawnGameConstant(INVTYPE_WEAPONMAINHAND), "IsMainHand", 1, BronzePawnMultipleStatsFixed}, -- Main Hand
	{BronzePawnGameConstant(INVTYPE_WEAPONOFFHAND), "IsOffHand", 1, BronzePawnMultipleStatsFixed}, -- Off Hand
	{BronzePawnGameConstant(INVTYPE_HOLDABLE)}, -- Held In Off-Hand; no BronzePawn stat for this
	{"^(%d-) %- (%d-) Damage$", "MinDamage", 1, BronzePawnMultipleStatsExtract, "MaxDamage", 2, BronzePawnMultipleStatsExtract}, -- Standard weapon
	{"^%+?(%d-) %- (%d-) Fire Damage$", "MinDamage", 1, BronzePawnMultipleStatsExtract, "MaxDamage", 2, BronzePawnMultipleStatsExtract}, -- Wand
	{"^%+?(%d-) %- (%d-) Shadow Damage$", "MinDamage", 1, BronzePawnMultipleStatsExtract, "MaxDamage", 2, BronzePawnMultipleStatsExtract}, -- Wand
	{"^%+?(%d-) %- (%d-) Nature Damage$", "MinDamage", 1, BronzePawnMultipleStatsExtract, "MaxDamage", 2, BronzePawnMultipleStatsExtract}, -- Wand, Thunderfury
	{"^%+?(%d-) %- (%d-) Arcane Damage$", "MinDamage", 1, BronzePawnMultipleStatsExtract, "MaxDamage", 2, BronzePawnMultipleStatsExtract}, -- Wand
	{"^%+?(%d-) %- (%d-) Frost Damage$", "MinDamage", 1, BronzePawnMultipleStatsExtract, "MaxDamage", 2, BronzePawnMultipleStatsExtract}, -- Wand
	{"^%+?(%d-) %- (%d-) Holy Damage$", "MinDamage", 1, BronzePawnMultipleStatsExtract, "MaxDamage", 2, BronzePawnMultipleStatsExtract}, -- Wand, Ashbringer
	{"^%+?(%d-) Weapon Damage$", "MinDamage", 1, BronzePawnMultipleStatsExtract, "MaxDamage", 1, BronzePawnMultipleStatsExtract}, -- Weapon enchantments
	{"^Equip: %+?(%d-) Weapon Damage%.$", "MinDamage", 1, BronzePawnMultipleStatsExtract, "MaxDamage", 1, BronzePawnMultipleStatsExtract}, -- Braided Eternium Chain
	{"^%+?(%d-) Damage$", "MinDamage", 1, BronzePawnMultipleStatsExtract, "MaxDamage", 1, BronzePawnMultipleStatsExtract}, -- Weapons with no damage range: Crossbow of the Albatross
	{"^Scope %(%+(%d-) Damage%)$", "MinDamage", 1, BronzePawnMultipleStatsExtract, "MaxDamage", 1, BronzePawnMultipleStatsExtract}, -- Ranged weapon scopes
	{"^%+?(%d+) [Aa]ll [Ss]tats$", "Strength", 1, BronzePawnMultipleStatsExtract, "Agility", 1, BronzePawnMultipleStatsExtract, "Stamina", 1, BronzePawnMultipleStatsExtract, "Intellect", 1, BronzePawnMultipleStatsExtract, "Spirit", 1, BronzePawnMultipleStatsExtract},
	{"^%+?(%d+) to All Stats$", "Strength", 1, BronzePawnMultipleStatsExtract, "Agility", 1, BronzePawnMultipleStatsExtract, "Stamina", 1, BronzePawnMultipleStatsExtract, "Intellect", 1, BronzePawnMultipleStatsExtract, "Spirit", 1, BronzePawnMultipleStatsExtract}, -- Enchanted Pearl, Enchanted Tear
	{"^%+?(%-?%d+) Strength$", "Strength"},
	{"^Potency$", "Strength", 20, BronzePawnMultipleStatsFixed}, -- weapon enchantment (untested)
	{"^%+?(%-?%d+) Agility$", "Agility"},
	{"^%+?(%-?%d+) Stamina$", "Stamina"},
	{"^%+?(%-?%d+) Intellect$", "Intellect"}, -- negative Intellect: Kreeg's Mug
	{"^%+?(%-?%d+) Spirit$", "Spirit"},
	{"^Titanium Weapon Chain$", "HitRating", 28, BronzePawnMultipleStatsFixed}, -- Weapon enchantment; has additional effects
	{"^%+?(%d+) Block$", "BlockValue"},
	...
	{"^Fiery Weapon$", "Dps", 4, BronzePawnMultipleStatsFixed}, -- weapon enchantment, 
	...
	{"^%+?(%d+) Ranged Critical Strike$", "CritRating"}, -- Heartseeker Scope (untested); BronzePawn doesn't distinguish between ranged and hybrid crit rating
	...
	{"^Surefooted$", "HitRating", 10, BronzePawnMultipleStatsFixed}, -- Enchantment (untested); has additional effects
	{"^Accuracy$", "HitRating", 25, BronzePawnMultipleStatsFixed, "CritRating", 25, BronzePawnMultipleStatsFixed}, -- weapon enchantment
	...
	{"^%+(%d+) Health and Mana every 5 sec$", "Mp5", 1, BronzePawnMultipleStatsExtract, "Hp5", 1, BronzePawnMultipleStatsExtract}, -- Greater Vitality boots enchantment
	...
	{"^Red Socket$", "RedSocket", 1, BronzePawnMultipleStatsFixed},
	{"^Yellow Socket$", "YellowSocket", 1, BronzePawnMultipleStatsFixed},
	{"^Blue Socket$", "BlueSocket", 1, BronzePawnMultipleStatsFixed},
	{"^Prismatic Socket$", "PrismaticSocket", 1, BronzePawnMultipleStatsFixed}, -- Prismatic / colorless sockets are added by blacksmithing
	{"^Meta Socket$", "MetaSocket", 1, BronzePawnMultipleStatsFixed},
	{"^\"Only fits in a meta gem slot%.\"$", "MetaSocketEffect", 1, BronzePawnMultipleStatsFixed}, -- Actual meta gems, not the socket
...
-- These regexes work exactly the same as BronzePawnRegexes, but they're used to parse the right side of tooltips.
-- Unrecognized stats on the right side are always ignored.
BronzePawnRightHandRegexes =
{
	{"^Speed ([%d%.,]+)$", "Speed"},
	{"^Arrow$", "IsBow", 1, BronzePawnMultipleStatsFixed},
	{"^Axe$", "IsAxe", 1, BronzePawnMultipleStatsFixed},
	{"^Bow$", "IsBow", 1, BronzePawnMultipleStatsFixed},
	{"^Bullet$", "IsGun", 1, BronzePawnMultipleStatsFixed},
	{"^Crossbow$", "IsCrossbow", 1, BronzePawnMultipleStatsFixed},
	{"^Dagger$", "IsDagger", 1, BronzePawnMultipleStatsFixed},
	{"^Fist Weapon$", "IsFist", 1, BronzePawnMultipleStatsFixed},
	{"^Gun$", "IsGun", 1, BronzePawnMultipleStatsFixed},
	{"^Mace$", "IsMace", 1, BronzePawnMultipleStatsFixed},
	{"^Polearm$", "IsPolearm", 1, BronzePawnMultipleStatsFixed},
	{"^Staff$", "IsStaff", 1, BronzePawnMultipleStatsFixed},
	{"^Sword$", "IsSword", 1, BronzePawnMultipleStatsFixed},
	{"^Thrown$", "IsThrown", 1, BronzePawnMultipleStatsFixed},
	{"^Wand$", "IsWand", 1, BronzePawnMultipleStatsFixed},
	{"^Cloth$", "IsCloth", 1, BronzePawnMultipleStatsFixed},
	{"^Leather$", "IsLeather", 1, BronzePawnMultipleStatsFixed},
	{"^Mail$", "IsMail", 1, BronzePawnMultipleStatsFixed},
	{"^Plate$", "IsPlate", 1, BronzePawnMultipleStatsFixed},
	{"^Shield$", "IsShield", 1, BronzePawnMultipleStatsFixed},
}